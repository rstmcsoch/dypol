    ...
    <main className="px-4 md:px-8 pt-6 pb-16">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-4 max-w-2xl text-muted-foreground">
          ...
          — cards below are teasers where you can drop your own links.
        </p>
          ...
          {PORTALS.map((p, i) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div
                  data-slot={`portal-${p.id}-logo`}
                  className="h-14 w-14 shrink-0 rounded-2xl border border-dashed border-border/60 grid place-items-center text-[9px] text-muted-foreground"
                >
                  logo
                </div>
