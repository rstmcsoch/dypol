    ...
    <main className="min-h-[calc(100vh-6rem)] px-4 grid place-items-center">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
        ...
        <div className="flex items-center justify-center gap-3">
          <div data-slot="logo" className="h-12 w-12 rounded-2xl gradient-primary grid place-items-center text-primary-foreground font-black">D</div>
          <div className="font-display font-black text-3xl tracking-tight">DYPOL<span className="text-primary">.</span></div>
        </div>
        ...
        <div className="mt-8 rounded-3xl border border-border glass-strong p-6 md:p-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground text-center">Pick how you'd like to continue.</p>
          ...
          <div className="mt-6 space-y-3">
            ...
            >
              <UserCircle className="h-4 w-4" /> Continue as Guest <ArrowRight className="h-4 w-4" />
            </button>
          </div>
          <p className="mt-4 text-xs text-muted-foreground text-center">
            By continuing you agree to Dypol's <span className="underline">Privacy</span> & <span className="underline">Terms</span>.
          </p>
        </div>
      </motion.div>
    </main>
